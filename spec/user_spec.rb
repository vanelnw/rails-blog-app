...
RSpec.describe User, type: :model do
  subject { User.new(name: 'Brice', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'I am a teacher', posts_counter: 1) }
  ...
  it 'name should be Rose' do
    expect(subject.name).to eql 'Brice'
  end
  ...
  it 'bio should be valid' do
    expect(subject.bio).to eql 'I am a teacher'
  end
